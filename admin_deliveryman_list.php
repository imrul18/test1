...
<html>
    ...
    <body>
        <?php            
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST" && $_REQUEST['button'] == "Add Delivery Man") {
                unset($_SESSION['del_id']);
                header('Location: admin_deliveryman_reg.php');
            }
        ...
        <div style = "text-align:right;">
            ...
            <input type="submit" value="Logout" name="button"> 
                ...
                <div style = "text-align:center;">
                    ...
                    <input type="submit" value="Add Delivery Man" name="button">

                </div>


                <fieldset>
                <legend><b>Delivery Man List:</b></legend>
